...
Enum "enum"
  = kEnum __ enumName:Identifier __ '{' __ enumBody:EnumBody* __ '}' EOS __ {
      return {
        type: 'Enum'
      , enumName: enumName
      , enumBody: enumBody
...
EnumField 'enum field'
  = __ enumKey:Identifier __ '=' __ enumOrder:NumericLiteral __ EOS __ {
      return {
        type: 'EnumField'
      , fieldName: enumKey
      , fieldOrder: enumOrder
...
kPackage 'key package'
  = 'package'

kMessage 'key message'
  = 'message'

kExtend 'key extend'
  = 'extend'

kExtensions 'key extensions'
  = 'extensions'
...
kService 'key service'
  = 'service'

kRpc 'key rpc'
  = 'rpc'

kReturns 'key returns'
  = 'returns'
...
NumericLiteral "number"
  = negative:('+'/'-')? literal:(HexIntegerLiteral / DecimalLiteral) !IdentifierStart {
      return negative == '-' ? -literal : literal
    }
  / negative:('+'/'-')? inf:InfToken {
